...
# pyinstaller --onefile --noconsole --name AircraftQuiz --icon='aircraft data/app_icon.ico' --add-data "aircraft data;aircraft data" 00_aircraft_quiz_v2.py

# Global Functions Here
def resource_path(relative_path):
    """ Get absolute path to resource. Get path to current working directory and combine it with relative path to resource. """
    try:
...
def get_csv_data():
    ...
    """
    csv_path = resource_path("Aircraft Data/00_aircraft.csv")
...
# Global Variables
font_name = "B612"
big_font = (font_name, "16", "bold")
med_font = (font_name, "12")
med_fontb = (font_name, "12", "bold")
small_font = (font_name, "10")
small_fontb = (font_name, "10", "bold")

# Global Icon Path
icon_path = resource_path("Aircraft Data/app_icon.ico")

# Start of Main Quiz Code
class StartGame():
    """
    ...
    def __init__(self):
        ...
        bg_path = resource_path("Aircraft Data/aircraft_background.jpg")
        ...
        self.start_instruct = Button(root, text=main_instructions, command=self.to_instructions,
                                   font=small_fontb, width=50, height=2, border=1, relief="solid")
        ...
        for item in start_radio_list:
            self.make_radio = Radiobutton(item[0], text=item[1], variable=item[2], value=item[3], width=item[4],
                                          font=small_font, bg="#aaaacc", selectcolor="#dddddd", height=2, border=1, relief="solid", indicatoron=0)
        ...
        self.round_instruct = Label(root, text=self.round_instructions,
                                   font=small_fontb, width=28, height=2, border=1, relief="solid")
        self.round_instruct.place(x=138, y=500)

        self.round_entry = Entry(root, font=big_font, width=16, border=1, relief="solid", justify="center")
        self.round_entry.place(x=138, y=550)

        # End & Start Game Buttons
        self.end_game_but = Button(root, text="🚫 End Quiz 🚫", command=root.destroy,
                                   font=big_font, width=13, border=1, relief="solid")
...
class Play():
    ...
    def __init__(self, how_many, imgname, filt1, filt2, filtered_aircraft):
        ...
        # Set Window Icon
        self.play_box.iconbitmap(icon_path)

        # Setup required for Background
        bg_path = resource_path("Aircraft Data/clouds_background.jpg")  # Use correct relative path
        bg_img = Image.open(bg_path)
        resize_img = bg_img.resize((500, 720), Image.Resampling.LANCZOS)  # Resize to fit window
    ...
    def next_round(self):
        ...
        for count, item in enumerate(self.round_aircraft):
            ...
            filepath = resource_path(f"Aircraft Data\{file}.jpg")
    ...
    def round_results(self, button_pressed):
        ...
        for count, button in enumerate(self.buttons_ref_list):
            ...
            # Color correct answer button green
            ...
            # Color all other buttons grey
            else:
                self.buttons_ref_list[count].configure(bg="#535353")

        # Update Rounds Played
        self.rounds_played += 1

        # Get name of aircraft corresponding to button user clicked
        ...
        for count, button in enumerate(self.buttons_ref_list):
            ...
            if user_button_name != self.ans_name:
                ...
                # Color users answer button red
                if user_button_name == button_name:
    ...
    def error_popup(self):
        ...
        # Set Window Icon
        self.error_box.iconbitmap(icon_path)
...
class DisplayInstructions():
    ...
    def __init__(self, partner):
        ...
        # Set Window Icon
        self.instructions_box.iconbitmap(icon_path)
...
class DisplayStats():
    ...
    def __init__(self, partner, all_stats_info):
        ...
        # Set Window Icon
        self.stats_box.iconbitmap(icon_path)
        ...
        self.dismiss_button.grid(row=4, padx=10, pady=5)
